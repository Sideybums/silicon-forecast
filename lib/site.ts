...
export const categories = [
 {slug:"ram",shortName:"RAM",name:"Memory (RAM)",status:"Public observations",marker:"3 dated offers",summary:"Capacity, DDR generation, kit configuration and speed.",detail:"Our first methodology focuses narrowly on 32GB (2×16GB) DDR5 desktop memory kits in the UK. Dated marketplace observations are now public while primary-retail index qualification remains gated.",considerations:["Capacity and module count must match exactly","Desktop UDIMM and laptop SO-DIMM products are kept separate","Speed, timings, model and manufacturer identifiers matter","Coverage limitations remain visible rather than being filled with estimates"]},
