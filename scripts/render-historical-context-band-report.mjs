...
<div class="note"><b>Read this before reading the chart.</b> The band is the <em>lowest and highest price actually observed</em> in each quarter — not an average, not an index, and not a market level. No central tendency is calculated because that would need an approved methodology this project does not have. Quarters marked ⚠ (hatched) rest on a single seller or fewer than three observations: in those, a change in band position may reflect <em>which products were archived</em> rather than any market movement. 2022-Q1 is the clearest example — its only evidence is two halo-tier G.Skill kits from one retailer, while 2021-Q4's single point is an entry-tier Crucial kit. The apparent rise between them is a sampling artefact, not a price rise.</div>
